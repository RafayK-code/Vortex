...
void SwapChain::createImageViews() 
{
    ...
    for (size_t i = 0; i < _swapChainImages.size(); i++) 
    {
        ...
        if (vkCreateImageView(_device.device(), &viewInfo, nullptr, &_swapChainImageViews[i]) != VK_SUCCESS)
...
void SwapChain::createFramebuffers() 
{
    ...
    for (size_t i = 0; i < imageCount(); i++) 
    {
        ...
        if (vkCreateFramebuffer(_device.device(), &framebufferInfo, nullptr, &_swapChainFramebuffers[i]) != VK_SUCCESS)
