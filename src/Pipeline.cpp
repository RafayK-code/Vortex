    ...
    : _device(device)
{
    ...
    createShaderModule(vertCode, &_vShaderModule);
    createShaderModule(fragCode, &_fShaderModule);

    VkPipelineShaderStageCreateInfo shaderStages[2];

    shaderStages[0].sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
    shaderStages[0].stage = VK_SHADER_STAGE_VERTEX_BIT;
    shaderStages[0].module = _vShaderModule;
    ...
    shaderStages[1].module = _fShaderModule;
...
Pipeline::~Pipeline()
{
    vkDestroyShaderModule(_device.device(), _vShaderModule, nullptr);
    vkDestroyShaderModule(_device.device(), _fShaderModule, nullptr);
